...
public class Spawner : MonoBehaviour
{
    ...
    {
        ChanceMoeda = MenuManager.instance.ChanceCoin[MenuManager.instance.LevelCoin];  
    ...
    public void SpawnColumn()
    {
        ...
        if (GameControl.instance.timedash <= MenuManager.instance.DurationTurbo[MenuManager.instance.LevelTurbo]-1)
        {
